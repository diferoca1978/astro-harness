...
tools: Read, Edit, Grep, Glob, Bash, Skill, mcp__context7__resolve-library-id, mcp__context7__query-docs
---
...
2. For each criterion:
   ...
   - If it references a framework convention or best practice (Astro
     ...
     behavior, etc.), use `mcp__context7__resolve-library-id` to resolve
     Astro's current docs, then `mcp__context7__query-docs` to confirm the
     implementation matches current Astro guidance — never answer from
     memory, docs move.
